import { CREATE_MiniTest_SUCCESS, CREATE_MiniTest_ERROR,CREATE_MiniTest_LOADING, 
    CLEAR_CREATE_MiniTest_STATE, GET_MiniTestS_LOADING, GET_MiniTestS_SUCCESS,
     GET_MiniTestS_ERROR, GET_SINGLE_MiniTestS_LOADING, GET_SINGLE_MiniTestS_SUCCESS,
...
import { addNewMiniTestService, loadMiniTestService, loadSingleMiniTestService,loadSearchMiniTestService, editMiniTestService, deleteMiniTestService } from "../../services/MiniTestService";
...
export const CreateMiniTestAction = (credentials) =>
{
    ...
    return (dispatch)=>{
        ...
        addNewMiniTestService(credentials).then((res)=>{
...
export const GetMiniTestActions = (id) =>
{
    ...
    return (dispatch)=>{
        ...
        loadMiniTestService(id,testId).then((res)=>{
...
export const GetSingleMiniTestAction = (id) =>
 {
    ...
    return (dispatch)=>{
        ...
        loadSingleMiniTestService(id).then((res)=>{
 ...
 export const GetSearchMiniTestAction = (searchData,page) =>
 {
    ...
    return (dispatch)=>{
        ...
        loadSearchMiniTestService(searchData,page).then((res)=>{
...
export const EditMiniTestAction = (credentials,id) =>
{
    ...
    return (dispatch)=>{
        ...
        editMiniTestService(credentials,id).then((res)=>{
...
export const DeleteMiniTestAction = (id)=>
{
    return (dispatch)=>
    {
        ...
        deleteMiniTestService(id).then((res)=>{
