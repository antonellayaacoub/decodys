...
export default function RegisterForm() {
  ...
  const registerResponse = useSelector(
    state => state.authReducer.registerState,
  );
        ...
        if (typeof registerResponse.message === 'string') {
          ...
          Object.keys(registerResponse.message).map((keys, index) => {
            ResponseToast(
              ...
              'Close',
              'danger',
              registerResponse.message[keys][0],
              6000,
            );
          });
        }
            ...
            <View>
              <Item
                ...
                <Input style={{
                  ...
                  onTouchStart={() =>
                    setBottomColor(_firstName, fields.firstname, null)
                  }
              ...
              <Item
                ...
                <Input style={{
                  ...
                  onTouchStart={() =>
                    setBottomColor(_lastName, fields.lastname, null)
                  }
              ...
              <Item
                ...
                <Input style={{
                  ...
                  onTouchStart={() =>
                    setBottomColor(_Email, fields.email, 'email')
                  }
              ...
              <Item
                ...
                <Input style={{
                  ...
                  onTouchStart={() =>
                    setBottomColor(_Password, fields.password, null)
                  }
              ...
              <DecodysButton
                ...
                buttonFunction={handleSubmitAfterFormikValidation}
                bgcolor="#0ACBC5"
                text={registerResponse == 'loading'
                    ? 'please wait...'
                    : 'Register'}
                color={'white'}
                outline={false}
