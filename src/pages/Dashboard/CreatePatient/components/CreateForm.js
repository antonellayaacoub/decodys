...
import { TouchableNativeFeedback,Image, Alert, ScrollView} from 'react-native'
...
import { CreatePatientAction, clearCreatePatientState } from '../../../../store/actions/PatientsAction';
...
export default function CreateForm() {
  ...
  const BUTTONS = [
   ...
   const createResponse = useSelector(state=>state.patientReducer.createPatientState);
  ...
  */ 
    useFocusEffect(
      React.useCallback(() => {
        ...
        return () => {
          dispatch(clearCreatePatientState())
        }
      }, [])
 ...
 const openFIleImage = () =>
 {
  ...
  }catch(e)
  {
    ...
    Alert.alert(
      ...
      "Patient Image Selection Error Please Try Again",
      [
         {
            text:"Ok",
 ...
 const onChangeNumber = ({dialCode, unmaskedPhoneNumber, phoneNumber, isVerified}) => 
 {
  console.log(dialCode, unmaskedPhoneNumber, phoneNumber, isVerified);
    ...
    if(phoneNumber=="")
   {
    ...
    _Phone.setNativeProps({ style: { borderBottomColor: '#ff4444' } });
    return;
   }   
   if(isVerified==false)
    {
    ...
    {
      setMobileErr("");
      _Phone.setNativeProps({ style: { borderBottomColor: '#0ACBC5' } });
      return;
    }  
};
