...
import { GetPatientActions, DeletePatientAction } from '../../../../store/actions/PatientsAction';
...
export default function ItemList() {
  ...
  const BUTTONS = [
    { text: "Edit Patient", icon: "image", iconColor: "#2c8ef4" },
    { text: "Delete Patient", icon: "trash", iconColor: "#f42ced" },
    { text: "Patient Me", icon: "md-person", iconColor: "#f42ced" },
   ...
   const CANCEL_INDEX = 3;
    ...
    const getResponse = useSelector(state=>state.patientReducer.getPatientState);

    const deleteResponse = useSelector(state=>state.patientReducer.deletePatientResponse);
...
}else if(BUTTONS[buttonIndex].text=="Delete Patient")
{
    ...
    Alert.alert(
        ...
        [
           ...
           {
               text:"OK",onPress:()=>deleteItem(patientId)
           },
