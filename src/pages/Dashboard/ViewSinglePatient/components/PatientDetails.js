...
import {GetSinglePatientAction} from '../../../../store/actions/PatientsAction';
...
export default function PatientDetails() {
  ...
  useEffect(() => {
    dispatch(GetSinglePatientAction(patientId));
      ...
      {singleResponse == '' || singleResponse == 'loading' ? (
        ...
        <>
          <View style={{marginTop: 20}}>
            {singleResponse.data.image_file == '' ||
            singleResponse.data.image_file == null ||
            ...
            <Text style={styles.name}>
              {singleResponse.data.firstname +
                ' ' +
                singleResponse.data.lastname}
            </Text>
          </View>
          <List>
            <ListItem style={styles.listCustomStyles}>
              <View style={styles.setViewWidth}>
                <Button
                  transparent
                  style={styles.flexDirectionForBtn}
                  onPress={() => {
                    callPatient(
                      singleResponse.data.country_code +
                        singleResponse.data.phonenumber,
                    );
                  }}>
              ...
              <View style={styles.setViewWidth}>
                <Button
                  ...
                  style={styles.flexDirectionForBtn}
                  onPress={() => {
                    this.emailPatient(singleResponse.data.email);
                  }}>
            ...
            <ListItem icon>
              <Left>
                <Button
                  style={styles.buttonStyle}
                  onPress={() => {
                    emailPatient(singleResponse.data.email);
                  }}>
