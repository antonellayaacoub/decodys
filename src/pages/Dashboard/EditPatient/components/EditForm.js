...
import { clearEditPatientState, GetSinglePatientAction, EditPatientAction } from '../../../../store/actions/PatientsAction';
...
if (base64Matcher.test(imageElem)) {
 ...
 const submitData = () =>
 {
  ...
  dispatch(EditPatientAction(data,patientId));
...
const changeCountry =(phoneNumber) =>
{
 ...
 useFocusEffect(
  React.useCallback(() => {
    ...
    return () => {
      dispatch(clearEditPatientState());
    }
  }, [])
