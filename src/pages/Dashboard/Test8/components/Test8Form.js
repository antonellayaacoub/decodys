...
import data from '../../../../data/Test8Data';
  ...
  useEffect(() => {
    if (singleResponse != '' || singleResponse != 'loading') {
      ...
      if (singleResponse.hasOwnProperty('data')) {
        ...
        dispatch(GetSingleTestAction(singleResponse.data.test_id, grade8));
  ...
  const handleNext = () => {
    if (currentQuestionIndex == allQuestions.length - 1) {
      ...
      if (pass && allQuestions[currentQuestionIndex]?.graded) {
        console.log('GradeEEEEEEEEEEEEEEEE previous: ', grade8);
        setGrade8(grade8 + 1);
        console.log('Grade81111111111111111111111111111111: ', grade8);
      }

      console.log('NAVIGATEEEEEEEE', grade8);
